...
exports.build = exports.Builder = exports.Writer = exports.Tree = exports.newBuilder = exports.importTreeSync = exports.importTree = exports.validateProofWithCredentials = void 0;
...
class Tree {
    ...
    addPathToProof(proof, key, label) {
        ...
        return addPathToProof(proof, leaf.value, this.algorithm, this.getPath(leaf.key), label);
    }
    /**
        ...
        return new Promise((res, rej) => {
            ...
            switch (__1.anchor.getAnchorType(proof.anchorType)) {
                ...
                case __1.anchor.Anchor.Type.ETH_MAINNET:
                    validateEthereumTransaction(proof.metadata.txnId, exp, false)
                        .then((r) => {
                        res(r);
                    })
                        .catch((e) => {
