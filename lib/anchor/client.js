...
exports.Client = exports.subscribeBatchesWithFilter = exports.getProofWithReturnBatch = exports.submitProofWithAwaitConfirmed = exports.submitProofWithReturnBatch = exports.submitProofWithSkipBatching = exports.submitProofWithFormat = exports.submitProofWithAnchorType = exports.connect = exports.withCredentials = exports.withInsecure = exports.withAddress = void 0;
    ...
    subscribeProof(proof, callback) {
        this.subscribeBatch((err, res) => {
            if (err) {
                ...
                this.getProof(proof.hash, proof.batchId, proof.anchorType, getProofWithReturnBatch(true))
