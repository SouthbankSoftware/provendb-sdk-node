    ...
    while (reader.nextField()) {
        ...
        switch (field) {
            ...
            case 3:
                ...
                break;
            case 4:
                var values = /** @type {!Array<!proto.anchor.Proof.Format>} */ (reader.isDelimited() ? reader.readPackedEnum() : [reader.readEnum()]);
...
proto.anchor.Proof.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getBatch();
    if (f != null) {
        writer.writeMessage(7, f, proto.anchor.Batch.serializeBinaryToWriter);
    }
};
/**
 * @enum {number}
...
proto.anchor.Proof.prototype.getBatch = function () {
    return /** @type{?proto.anchor.Batch} */ (jspb.Message.getWrapperField(this, proto.anchor.Batch, 7));
};
/**
...
proto.anchor.SubscribeBatchesRequest.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getFilter();
    if (f != null) {
        writer.writeMessage(1, f, proto.anchor.BatchRequest.serializeBinaryToWriter);
    }
};
/**
...
proto.anchor.SubscribeBatchesRequest.prototype.getFilter = function () {
    return /** @type{?proto.anchor.BatchRequest} */ (jspb.Message.getWrapperField(this, proto.anchor.BatchRequest, 1));
};
/**
...
//# sourceMappingURL=anchor_pb.js.map