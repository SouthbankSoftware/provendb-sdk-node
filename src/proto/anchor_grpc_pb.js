...
function serialize_anchor_Anchor(arg) {
  if (!(arg instanceof anchor_pb.Anchor)) {
...
function deserialize_anchor_Anchor(buffer_arg) {
  return anchor_pb.Anchor.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_anchor_AnchorRequest(arg) {
  if (!(arg instanceof anchor_pb.AnchorRequest)) {
...
function deserialize_anchor_AnchorRequest(buffer_arg) {
  return anchor_pb.AnchorRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_anchor_Batch(arg) {
  if (!(arg instanceof anchor_pb.Batch)) {
...
function deserialize_anchor_Batch(buffer_arg) {
  return anchor_pb.Batch.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_anchor_BatchRequest(arg) {
  if (!(arg instanceof anchor_pb.BatchRequest)) {
...
function deserialize_anchor_BatchRequest(buffer_arg) {
  return anchor_pb.BatchRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_anchor_Proof(arg) {
  if (!(arg instanceof anchor_pb.Proof)) {
...
function deserialize_anchor_Proof(buffer_arg) {
  return anchor_pb.Proof.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_anchor_ProofRequest(arg) {
  if (!(arg instanceof anchor_pb.ProofRequest)) {
...
function deserialize_anchor_ProofRequest(buffer_arg) {
  return anchor_pb.ProofRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_anchor_SubmitProofRequest(arg) {
  if (!(arg instanceof anchor_pb.SubmitProofRequest)) {
...
function deserialize_anchor_SubmitProofRequest(buffer_arg) {
  return anchor_pb.SubmitProofRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_anchor_SubscribeBatchesRequest(arg) {
  if (!(arg instanceof anchor_pb.SubscribeBatchesRequest)) {
...
function deserialize_anchor_SubscribeBatchesRequest(buffer_arg) {
  return anchor_pb.SubscribeBatchesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_anchor_VerifyProofReply(arg) {
  if (!(arg instanceof anchor_pb.VerifyProofReply)) {
...
function deserialize_anchor_VerifyProofReply(buffer_arg) {
  return anchor_pb.VerifyProofReply.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_anchor_VerifyProofRequest(arg) {
  if (!(arg instanceof anchor_pb.VerifyProofRequest)) {
...
function deserialize_anchor_VerifyProofRequest(buffer_arg) {
  return anchor_pb.VerifyProofRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
getAnchor: {
    ...
    requestType: anchor_pb.AnchorRequest,
    responseType: anchor_pb.Anchor,
...
getProof: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: anchor_pb.ProofRequest,
    responseType: anchor_pb.Proof,
...
submitProof: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: anchor_pb.SubmitProofRequest,
    responseType: anchor_pb.Proof,
...
verifyProof: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: anchor_pb.VerifyProofRequest,
    responseType: anchor_pb.VerifyProofReply,
...
getBatch: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: anchor_pb.BatchRequest,
    responseType: anchor_pb.Batch,
...
subscribeBatches: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: anchor_pb.SubscribeBatchesRequest,
    responseType: anchor_pb.Batch,
